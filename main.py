...
kata_speed_config = {
    ...
    "engine": "Kata_web custom trained KW serie network(Switched to b18c384nbt for speed. around 20 elo weaker than offical) with 10M parameters. Currently using KW29.",
    "allow_unranked": True,
    "farewellscore": True,
    "bot": {
        "send_pv_data": True,
